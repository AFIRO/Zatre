...
public class Scoreblad {
    ...
    /**
     * UC3: gebruikt stream om per opgeslagen ScorebladRegel uit lijst regels de
     * punten op te vragen en telt deze dan op. Hierdoor wordt de uiteindelijke som
     * berekend.
     *
     * @return int score
     */
    public int berekenScoreVanScoreblad() {
        return regels.stream().map(ScorebladRegel::getScoreVoorRegel).reduce(0, Integer::sum);
    }
