...
public class SpelerRepository {
    ...
    /**
     * UC1: een instantie van speler cre�eren en doorgeven aan de Mapper om zo in de
    ...
    /**
     * UC2: vraagt de Speler op via de Mapper-klasse en voegt deze toe aan lijst
     * Spelers controleert hierbij of er nog speelkansen zijn, of deze speler al in
     * de lijst zit en of er nog niet teveel spelers zijn
     *
     * @param gebruikersnaam Gebruikersnaam van de speler
     * @param geboortejaar   Geboortejaar van de speler
     */
    ...
    /**
     * UC2: controleert of gekozenSpeler toegevoegd werd aan lijst spelers en geeft
     * speler terug
     *
     * @param gebruikersnaam Gebruikersnaam van de speler
     * @param geboortejaar   Geboortejaar van de speler
    ...
    /**
     * UC2: geeft de nieuwe speelkansen door aan de mapper om aan te passen in de
     * database
     *
